param (
    ...
    [string]$task_name = [guid]::NewGuid().ToString()
)
...
try {
    ...
    py -m windows_arena --task $task_name --request $instructionEscaped --agent_settings $jsonEscaped 2>&1 | Tee-Object -FilePath $outputFile -Append
} catch {
